...
- 当前发布收口聚焦强敌链漂的公平性与可读性：第四飞后的水面控制不再出现反向刹车，
  对手技巧改由真实 Boat 状态驱动的艇尾风切表达，并同步降低全局赛璐珞块面竞争。
...
- 对手旧漂移粒子、水花和独立 BOOST 扇面已经由单一艇尾风切替换：真实 hold 显示暖色
  三段折线，真实释放短暂转绿，再次 hold 换侧；普通尾流降为 `.68`，不再吞掉技巧。
- 海面主色带、碎泡沫和闪点已整体降噪，通用 toon 光照改为八级细分；墨线、波形、
  绿色水面路线与青色飞行路线保持原有所有权和对比合同。
