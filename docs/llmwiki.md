...
- 视觉语法固定为 `半透明青色虚拟航道 -> 随浪起伏的半透明绿色薄雾`。穿过计分门后，
  recovery 与 surface 必须共用同一套绿色薄雾、开放尖角、波浪位移和流动节奏；触水
  不是换材质或换视觉所有权的时机。青色航道用低透明面、扫描节奏、细墨边和白色流光
...
- 七个起飞入口统一使用同一套世界内升空向量，不用字幕或 HUD 冒充路线：水面主线在
  ...
  开放尖角粒子沿整条弧线前进；因此入口同时回答“何时飞”和“朝哪里、以什么姿态飞”。
...
- 青色只承担“可飞行空间”语义，材质语言是可持续辨认的半透明虚拟面、青白风痕、
  ...
  平板。禁止恢复紫色能量管、连续实体墙或 bloom 堆亮。黄/白 action marker 靠形状区分，颜色
...
- 整圈绿色水面主线采用随浪薄雾 + 导航脊：base alpha 约 `.17`、峰值不超过 `.58`，
  ...
  验证 unarmed / armed / committed，且 committed 时水面门阵撤场。七条空中分支门前
