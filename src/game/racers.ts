...
export const DRIVER_PROFILES: readonly DriverProfile[] = [
  ...
  {
    id: 'tide', name: 'TIDE', callsign: '潮汐', age: 27, pronouns: '她', portraitUrl: tidePortrait, portraitPosition: '50% 20%',
  ...
  {
    id: 'sol', name: 'SOL', callsign: '日曜', age: 26, pronouns: '她', portraitUrl: solPortrait, portraitPosition: '50% 20%',
  ...
  {
    id: 'reef', name: 'REEF', callsign: '礁锋', age: 31, pronouns: '他', portraitUrl: reefPortrait, portraitPosition: '50% 20%',
  ...
  {
    id: 'kai', name: 'KAI', callsign: '界线', age: 30, pronouns: '他', portraitUrl: kaiPortrait, portraitPosition: '50% 20%',
  ...
  {
    id: 'jinx', name: 'JINX', callsign: '变数', age: 25, pronouns: '他', portraitUrl: jinxPortrait, portraitPosition: '50% 20%',
